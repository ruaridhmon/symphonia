...
- **2026-02-28:** Updated dev Firebase project ID from legacy dev project to `symphonia-dev-488613` in `.firebaserc` alias and GitHub Actions deploy `projectId` fields. Dev Cloud Run rewrite remains in `firebase.dev.json`.
