...
# Expert personas
EXPERTS = [
    {"email": "prof.chen@oxford.ac.uk", "name": "Prof. Sarah Chen", "role": "AI Ethics, Oxford University"},
    {"email": "m.okonkwo@cabinet-office.gov.uk", "name": "Dr. Michael Okonkwo", "role": "Chief Digital Officer, Cabinet Office"},
    {"email": "j.mueller@fraunhofer.de", "name": "Dr. Julia Müller", "role": "Director, Fraunhofer Institute for AI"},
    {"email": "r.patel@tuc.org.uk", "name": "Rajesh Patel", "role": "Head of Digital Policy, TUC"},
    {"email": "a.bergstrom@oecd.org", "name": "Anna Bergström", "role": "Senior Policy Analyst, OECD"},
    {"email": "d.thompson@deepmind.com", "name": "David Thompson", "role": "Policy Director, DeepMind"},
    {"email": "l.santos@unesco.org", "name": "Dr. Lucia Santos", "role": "AI & Education Specialist, UNESCO"},
    {"email": "k.yamamoto@meti.go.jp", "name": "Kenji Yamamoto", "role": "Digital Strategy Advisor, Japan METI"},
    {"email": "e.oduya@worldbank.org", "name": "Dr. Emmanuel Oduya", "role": "Digital Development, World Bank"},
    {"email": "s.williams@ada-lovelace.org", "name": "Dr. Sophie Williams", "role": "Research Director, Ada Lovelace Institute"},
]
...
CONSULTATIONS = [
    ...
    },
    {
        ...
        "questions": [
            {"id": "q1", "type": "textarea", "label": "What should be the UK's top 3 strategic priorities for AI development and adoption?", "required": True},
            {"id": "q2", "type": "textarea", "label": "How should government balance innovation promotion with risk mitigation?", "required": True},
            {"id": "q3", "type": "textarea", "label": "What role should public investment play versus private sector leadership?", "required": True},
            {"id": "q4", "type": "select", "label": "Which sector should receive priority focus for AI transformation?",
             "options": ["Healthcare (NHS)", "Education", "Climate & Energy", "Defence & Security", "Public Administration"], "required": True},
        ],
        "responses": [
            {
    ...
    },
    {
        ...
        "questions": [
            {"id": "q1", "type": "textarea", "label": "Which occupations and sectors face the greatest disruption from AI automation?", "required": True},
            {"id": "q2", "type": "textarea", "label": "What retraining and skills programmes should government prioritise?", "required": True},
            {"id": "q3", "type": "textarea", "label": "How should social safety nets adapt to support affected workers?", "required": True},
            {"id": "q4", "type": "select", "label": "What is the appropriate timescale for major workforce transition policies?",
             "options": ["Immediate (within 2 years)", "Medium-term (2-5 years)", "Long-term (5-10 years)", "Transition is overstated"], "required": True},
        ],
        "responses": [
            {
                "expert": "r.patel@tuc.org.uk",
    ...
    },
    {
        ...
        "questions": [
            {"id": "q1", "type": "textarea", "label": "What are the most promising applications of AI for NHS service delivery?", "required": True},
            {"id": "q2", "type": "textarea", "label": "What governance frameworks are needed for clinical AI deployment?", "required": True},
            {"id": "q3", "type": "textarea", "label": "How should patient data be handled for AI development while protecting privacy?", "required": True},
            {"id": "q4", "type": "select", "label": "Should AI diagnostic tools be permitted to operate without human oversight in specific contexts?",
             "options": ["Yes, for low-risk screening", "Yes, with automatic escalation protocols", "No, always require clinician review", "Needs more research before deciding"], "required": True},
        ],
        "responses": [
            {
                "expert": "m.okonkwo@cabinet-office.gov.uk",
...
def seed_database():
    ...
    try:
        ...
        for consultation in CONSULTATIONS:
            ...
            existing = db.query(FormModel).filter(FormModel.title == consultation["title"]).first()
            if existing:
            ...
            db.commit()
            print(f"✓ Created '{consultation['title']}' with {len(consultation['responses'])} responses")
