...
/**
 * Expert dashboard — join consultations via code, view/enter joined forms.
 * No form creation capability (experts cannot create consultations).
 */
      ...
      <Container size="md">
        {error && (
          ...
          >
            ...
            <LoadingButton variant="destructive" size="sm" onClick={fetchMyForms}>
              Retry
            </LoadingButton>
          </div>
        )}
        ...
        >
          ...
          <form onSubmit={handleUnlock} className="space-y-4">
            ...
            {joinError && (
              <p className="text-sm text-center" style={{ color: 'var(--destructive)' }}>{joinError}</p>
            )}
        ...
        {/* My Consultations (joined via code) */}
        <div
