...
const stageIcons: Record<string, ReactNode> = {
  ...
  committee_deliberation: <Brain size={16} style={{ color: 'var(--accent)' }} />,
  thorough_synthesis: <Brain size={16} style={{ color: 'var(--accent)' }} />,
...
const stageTranslationKeys: Record<string, string> = {
  ...
  committee_deliberation: 'synthesis.progress.committeeDeliberation',
  thorough_synthesis: 'synthesis.progress.thoroughSynthesis',
